...
public class JwtTokenGeneratorTests {
    ...
    public void setup() throws NoSuchFieldException, IllegalAccessException {
        UserRole testUserRole = new UserRole("customer");
        ArrayList<UserRole> testGrantedAuthorities = new ArrayList<>();
        testGrantedAuthorities.add(testUserRole);
        ...
        user = new User(netId, "someHash", testGrantedAuthorities);
    }
    ...
    @Test
    public void generatedTokenHasCorrectDefaultRole() {
        // Act
        String token = jwtTokenGenerator.generateToken(user);
