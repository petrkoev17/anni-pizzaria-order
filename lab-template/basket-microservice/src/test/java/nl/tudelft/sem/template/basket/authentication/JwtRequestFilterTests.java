...
public class JwtRequestFilterTests {
    private transient JwtReqFilter jwtRequestFilter;
    ...
    public void setup() {
        ...
        mockJwtTokenVerifier = Mockito.mock(JwtTokenVerify.class);

        jwtRequestFilter = new JwtReqFilter(mockJwtTokenVerifier);
    ...
    public void correctToken() throws ServletException, IOException {
        ...
        when(mockJwtTokenVerifier.getUserRoleFromToken(token)).thenReturn(new UserRole("customer"));
